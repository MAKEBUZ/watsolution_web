...
describe('Service Tests', () => {
  describe('Invoice Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Invoice(123, currentDate, currentDate, 0, 0, 'PENDING', currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Invoice', async () => {
        ...
        const expected = { issueDate: currentDate, dueDate: currentDate, createdAt: currentDate, ...returnedFromService };
