...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'watsolution';
  ...
  'jhipster.mail.from' = 'watsolution@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'watsolution API';
  'jhipster.swagger.description' = 'watsolution API documentation';
  ...
  'eureka.instance.appname' = 'watsolution';
  'eureka.instance.instanceId' = 'watsolution:${random.value}';
